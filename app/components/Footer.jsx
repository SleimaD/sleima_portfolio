...
const Footer = () => {
  return (
    <div className=" w-full mb-0 bottom-0 flex items-center justify-between h-[180px] text-white bg-[#5c118150] p-5 backdrop-blur-xl">
        ...
        <div className={`w-full flex justify-center items-center gap-10 ${bagelFatOne.className}`}>
            ...
            >
                ...
                <span
                className="absolute opacity-0 group-hover:opacity-100 group-hover:text-[#fff] group-hover:text-sm group-hover:-translate-y-10 duration-700"
                >
                GitHub
                </span>
            </a>
            ...
            <div className="flex justify-center items-center">
                ...
                >
                    ...
                    <span
                    className="absolute opacity-0 group-hover:opacity-100 group-hover:text-[#fff] group-hover:tracking-wider group-hover:text-sm group-hover:-translate-y-10 duration-700"
                    >
                    Linkedin
                    </span>
                </a>
