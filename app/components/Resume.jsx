  ...
  return (
    <div className='w-full p-4'>
        <div className='w-full flex flex-col justify-center items-center mt-10  '>
          <h2 className={`text-white text-5xl tracking-wide ${bagelFatOne.className} mt-16 max-[426px]:mt-[-3rem] underline md:mb-[-3.5rem] md:text-4xl sm:text-3xl`}>
            Education
          </h2>

          <section className="design-section mt-5 w-full ">
            <div className="timeline">
              ...
              <div className="timeline-component shadow-inner timeline-content max-[426px]:w-[20rem] max-[426px]:m-1 max-[376px]:m-[-1rem] max-[426px]:mt-[-3rem] max-[376px]:mt-[-4rem]">
                ...
                <p className='text-[0.9rem] max-[426px]:text-[0.5rem] font-mono'>
              ...
              <div className="timeline-component shadow-inner timeline-content max-[426px]:w-[20rem] max-[426px]:m-1 max-[376px]:m-[-1rem] max-[376px]:mt-8">
          ...
          <h2 className={`text-white text-5xl tracking-wide ${bagelFatOne.className} mt-10 max-[426px]:mt-[-3rem] underline md:mb-[-3.5rem] md:text-4xl sm:text-3xl`}>
            Experience
          </h2>

          <section className="design-section h-auto mb-10 w-full">
            <div className="timeline">
              ...
              <div className="timeline-component shadow-inner timeline-content max-[426px]:w-[20rem] max-[426px]:m-1 max-[376px]:m-[-1rem] max-[426px]:mt-[-3rem]">
                <h3 className='font-bold font-serif mb-2'>Full Stack Web Development <small className='text-sm'>(Professional training)</small></h3>
                <p className='text-[0.9rem] mb-4'>Molengeek (2023 - 2024)</p>
                <p className='text-[0.7rem] max-[426px]:text-[0.6rem] font-mono'>
              ...
              <div className="timeline-component shadow-inner timeline-content max-[426px]:w-[20rem] max-[426px]:m-1 max-[376px]:m-[-1rem] max-[376px]:mt-8">
                ...
                <p className='text-[0.7rem] max-[426px]:text-[0.6rem] font-mono'>
                  Handled the cash register and stocked shelves, using organizational skills and providing good customer service.
                </p>
              </div>
              ...
              <div className="timeline-component shadow-inner timeline-content max-[426px]:w-[20rem] max-[426px]:m-1 max-[376px]:m-[-1rem] max-[376px]:mt-8">
                ...
                <p className='text-[0.7rem] font-mono'>
                  Registered incoming clients, managed gaming machines, handled cash flow.
                </p>
              </div>
            </div>
          </section>

          <h2 className={`text-white text-5xl tracking-wide ${bagelFatOne.className} mt-5 mb-5 underline md:text-4xl sm:text-3xl max-[426px]:mt-[-4rem]  `}>
            Skills
          </h2>

          <div className="mt-16 mb-[10rem] flex justify-center text-center"> 
            <div className="flex flex-wrap justify-center gap-5 w-[80%] max-[426px]:w-[96%] text-center">
                {SkillsData.map((element, index) => (
                    <div key={index} className="boite bg-[#fff] w-[6rem] h-[6rem] flex flex-col gap-3 justify-center items-center p-3 rounded-xl shadow-inner cursor-pointer transition-colors max-[426px]:w-[5rem] max-[426px]:h-[4.8rem] " onClick={() => openModal(element)}>
                        <Image src={element.image} width={40} height={760} alt={element.name} className='max-[426px]:w-[2rem]' />
                        <p className='text-[0.7rem] max-[426px]:text-[0.6rem] font-mono font-bold'>{element.name}</p>
                    </div>
                ))}                                                    
            </div>
